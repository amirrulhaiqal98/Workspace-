        ...
        <div class="col-lg-8 offset-lg-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Workspace: {{ $workspace->name }}</h3>
                </div>
                <form method="POST" action="{{ route('workspaces.update', $workspace) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="Enter workspace description (optional)">{{ old('description', $workspace->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('workspaces.show', $workspace) }}" class="btn btn-secondary">
